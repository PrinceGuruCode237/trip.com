...
function CTA() {
  return (
    <section className="w-full relative bg-primary h-[50vh] md:h-[80vh]">
      <div className="w-4/5  md:w-1/2 z-[999] mx-auto h-full flex flex-col items-center justify-center">
        <div className="flex flex-col gap-4 pb-6  justify-center items-center">
          <h1 className="text-4xl z-[999] md:text-5xl font-bold  text-white">
            Journey to Padar Island
          </h1>
          <p
            className={`text-base z-[999] text-center md:text-lg text-gray-200`}
          >
