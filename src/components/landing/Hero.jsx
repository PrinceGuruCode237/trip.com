...
const Hero = () => {
  return (
    <section className="hero relative lg:min-h-[150vh] min-h-[120vh] mb-14  overflow-hidden">
      <div className="overlay -z-0 pointer-events-none  absolute h-full w-full"></div>
      <div className="overlay--2 -z-1 absolute  w-full"></div>
      <div className="filters flex  md:px-14  md:w-[80%] z-[9999]  bg-white absolute bottom-0">
        <div className="z-[9999] md:hidden w-[150px]  py-4 flex items-center gap-2 cursor-pointer">
          <h3
        ...
        <div className="bg-primary w-[100px] flex flex-col justify-center items-center">
      ...
      <div className="mx-6 pb-10    md:mx-14 flex justify-center items-center flex-row  w-full  h-full">
        <div className="flex flex-col z-[999] h-full justify-center gap-4 md:gap-6 text-white">
        ...
        <div className="flex gap-4 lg:py-10  h-full z-[999]   before:w-[1px] after:w-[1px] after:h-[25%] after:bg-gray-400 before:h-[25%] before:bg-gray-400 flex-col items-center w-1/2">
          <a
            href="#"
      ...
      <div className="form z-[99999] bg-red-500 h-60 w-60 "></div>
    </section>
  );
};
